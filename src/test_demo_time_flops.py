...
def profile_model(model, input_tensor):
    ...
    # print(f"The FLOPs of the Variant is {flops}, with Params {params}.")
    # print(f"The FLOPs of the Variant is {flops/1e9:.6f}G, with Params {params/1e6:.2f}M.\n")
    return flops, params
...
if __name__ == '__main__':
    ...
    for i in range(num_runs):
        quality_prediction, run_time = evaluate_video_quality(config, data_loader, model_slowfast, model_swint, model_mlp)
