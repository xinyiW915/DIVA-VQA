...
def main(config):
    ...
    result_file = f'{result_path}{data_name}_{network_name}_{model_name}_corr_{select_criteria}.mat'
    ...
    file_path = os.path.join(save_path, f"{data_name}_{network_name}_{model_name}_{select_criteria}_trained_median_model_param.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, default='youtube_ugc', help='konvid_1k, youtube_ugc, live_vqc, cvd_2014, live_qualcomm, lsvq_train, cross_dataset')
    parser.add_argument('--network_name', type=str, default='diva-vqa_large' , help='diva-vqa, diva-vqa_tiny, diva-vqa_small, diva-vqa_large')

    parser.add_argument('--metadata_path', type=str, default='../metadata/')
    parser.add_argument('--feature_path', type=str, default=f'../features/diva-vqa/diva-vqa_large/', help='../features/diva-vqa/')
    ...
    parser.add_argument('--epochs', type=int, default=200, help='Epochs for training') # 200(small), 20(big)
